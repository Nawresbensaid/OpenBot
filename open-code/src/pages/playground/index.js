...
function Playground() {
    ...
    const connectWebots = useCallback(() => {
        ...
        try {
            ...
            ws.onmessage = (e) => {
                try { const m = JSON.parse(e.data); if (m.type === 'camera') return; } catch (_) { }
                setWsLog('📩 ' + e.data);
            };
        } catch (e) {
